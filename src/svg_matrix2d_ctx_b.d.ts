...
export interface svg_matrix2d_ctx_ctx_I extends svg_margin_Ctx, svg_width_Ctx, svg_height_Ctx, svg_content_width_Ctx, svg_content_height_Ctx {
    svg_matrix2d_ctx?: svg_matrix2d_ctx_T;
}
export declare const svg_matrix2d_ctx_b: import("@ctx-core/object").Be<svg_matrix2d_ctx_ctx_I, "svg_matrix2d_ctx">;
