 ...
 */
export declare function _markup(builder_opts?: _markup_builder_opts_type): markup_type;
...
export declare type markup_type = (opts: _match_opts_type) => Promise<_markup_fn_return_type | undefined>;
