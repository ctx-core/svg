...
export const svg_content_height_b:svg_content_height_b_type = _b('svg_content_height', ()=>
...
export interface svg_content_height_b_type extends B<svg_content_height_type> {}
export {
