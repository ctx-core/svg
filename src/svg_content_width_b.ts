...
export const svg_content_width_b:svg_content_width_b_type = _b('svg_content_width', ()=>
...
export interface svg_content_width_b_type extends B<svg_content_width_type> {}
export {
