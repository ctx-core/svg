...
export const svg_content_height_b = _b<svg_content_height_type>('svg_content_height', ()=>
	writable(null))
export type $svg_content_height_type = number
export type $maybe_svg_content_height_type = maybe_null<$svg_content_height_type>
export type svg_content_height_type = Writable<$maybe_svg_content_height_type>
export {
